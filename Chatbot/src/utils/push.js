...
export const needsInstallForPush = () => detectPlatform() === "ios" && !isStandalone();
...
export async function enablePush() {
    if (needsInstallForPush()) throw new Error("On iPhone and iPad, add GH-GPT to your Home Screen first, then turn on notifications from the app.");
...
export async function syncPushSubscription() {
    try {
        // Permission already granted on this device: subscribe it even if it never was.
